...
| غیر فعال | ❌ = حذف نشدن پیام",
 ...
 ['text'=>"🔗 لينک",'callback_data'=>'text'],['text'=>"$locklink",'callback_data'=>'locklink']
  ...
  [
 ['text'=>"🔗 تبچی",'callback_data'=>'text'],['text'=>"$locktab",'callback_data'=>'locktab']
 ],
  [
...
🔻از دکمه های زیر استفاده کنید",
   ...
   [
   ['text'=>"📝 قفل کاراکتر",'callback_data'=>'character']
   ],
   [
...
ℹ️ با دستور  `نصب ` میتوانید ربات را  رایگان فعال کنید ",
  'reply_to_message_id'=>$message_id,
