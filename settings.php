...
elseif($data=="locktabchi" && $settings2["lock"]["tabchi"] =="| فعال | ✅" or $data=="lockforward" && $settings2["lock"]["forward"] =="| فعال | ✅" or $data=="lockfosh" && $settings2["lock"]["fosh"] =="| فعال | ✅" or $data=="lockedit" && $settings2["lock"]["edit"] =="| فعال | ✅" or $data=="lockusername" && $settings2["lock"]["username"] =="| فعال | ✅" or $data=="locklink" && $settings2["lock"]["link"] == "| فعال | ✅" or $data=="lockbot" && $settings2["lock"]["bot"] =="| فعال | ✅"  or $data=="locktgservic" && $settings2["lock"]["tgservic"] =="| فعال | ✅" or $data=="lockreply" && $settings2["lock"]["reply"] =="| فعال | ✅" or $data=="lockcmd" && $settings2["lock"]["cmd"] =="| فعال | ✅" or $data=="locktag" && $settings2["lock"]["tag"] =="| فعال | ✅"){
if ($statusq == 'creator' or $statusq == 'administrator' or in_array($fromid,$Dev) ){
$getlock = array("lockforward","lockfosh","lockedit","lockusername","locklink","lockbot","locktgservic","lockreply","lockcmd","locktag","locktabchi");
$howlock = array("forward","fosh","edit","username","link","bot","tgservic","reply","cmd","tag","tabchi");
$text = array("فوروارد","کلمات رکیک","ویرایش","یوزرنیم","لینک","ورود ربات","خدمت تلگرام","ریپلای","دستورات عمومی","هشتگ","تبچی");
$lock = str_replace($getlock,$howlock,$data);
$gettext = str_replace($getlock,$text,$data);
$settings2["lock"]["$lock"]="| غیر فعال | ❌";
...
$locktab = $settings2["lock"]["tabchi"];
 ...
 ['text'=>"🔗 لينک",'callback_data'=>'text'],['text'=>"$locklink",'callback_data'=>'locklink']
   ...
   [
 ['text'=>"🔗 تبچی",'callback_data'=>'text'],['text'=>"$locktab",'callback_data'=>'locktabchi']
 ],
  [
